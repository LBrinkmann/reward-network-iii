const instructions = {
  welcome: [""],
  practice_rounds: [
    "Well done! Next, you will practice  with two more complex networks. Try to maximize the number of points in each round, just as you want to do in the main task where they count towards your bonus payment!",
  ],
  ...
  demonstration: [
    "Well done! You now enter the final part of the experiment. Now you will play four more rounds that serve as demonstrations for future players to learn from. Another part of your bonus payment depends on the performance of people that learn from you, so try your best!",
  ],
  written_strategy: ["Please write down your strategy in solving the task."],
  consent_decline: [
    "You have declined to participate in the experiment. Thank you for your time. Please return the study on Prolific.",
  ],
};
