const instructions = {
  welcome: [""],
  practice_rounds: [
    "Well done! Next, you will practice with two more complex networks. Try to maximize the number of points for each network -- remember that, later, they count towards your bonus payment!",
  ],
  ...
  learning_selection: [
    "Now, you have the opportunity to learn from the solutions submitted by a previous player. Think of them like a teacher.",
    "This “learning phase” is intended to prepare you for the next stage, where your moves through the networks will be recorded for future players to learn from."
  ],
  pre_social_learning: [
